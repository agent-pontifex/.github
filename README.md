...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`agent-pontifex`](https://github.com/agent-pontifex).

## Canonical organization links

- GitHub organization: https://github.com/agent-pontifex
- Public organization defaults: https://github.com/agent-pontifex/.github
- Canonical Linear project: https://linear.app/denman/project/githubcomagent-pontifex-1d2deb2be3c7
...
`agent-pontifex` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
